...
protected  World world;
    ...
    protected IBlockState baseBlock = Blocks.STONE.getDefaultState();//ModBlocks.cloud.getDefaultState();
    protected IBlockState oceanBlock = Blocks.LAVA.getDefaultState();
...
//    private int waterLakeChance =4;
    ...
    public ChunkGeneratorHive(World worldIn)
    {
    	// DEBUG
        System.out.println("***Constructing ChunkGeneratorHive");
